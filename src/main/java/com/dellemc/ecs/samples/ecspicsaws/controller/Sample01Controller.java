...
/**
 * In this first sample, we will create a controller to upload a file to ECS.
 */
@Controller
public class Sample01Controller {
    private static final String CONTROLLER = "/sample1";
    private static final Log log = LogFactory.getLog(Sample01Controller.class);
    ...
    public String processUpload(@RequestParam("file") MultipartFile file,
        ...
        // TODO: configure the ObjectMetadata

        // TODO: Insert your code here to upload the object.
